...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "City Gym Shahdara — Stronger Every Day" },
      {
        name: "description",
        content:
          "Premium fitness gym in Naveen Shahdara, Delhi. Expert coaching, modern equipment, personal training and a community that keeps you motivated.",
      },
